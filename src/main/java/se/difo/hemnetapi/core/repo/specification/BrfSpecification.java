...
public class BrfSpecification extends BaseSpecification implements Specification<BrfEntity> {

    private BrfSpecification(SearchCriteria criteria) {
        super(criteria);
    }
